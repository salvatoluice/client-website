...
const HeroSection = () => {
  ...
  <div class="relative container mx-auto my-auto px-4 py-24">
    ...
    <div class="flex items-center space-x-4 mb-8">
      <a target='_blank' href="https://facebook.com/" class="text-white hover:text-gray-200 transition duration-300">< FaFacebookF /></a>
      <a target='_blank' href="https://twitter.com/" class="text-white hover:text-gray-200 transition duration-300"><AiOutlineTwitter /></a>
      <a target='_blank' href="https://instagram.com/" class="text-white hover:text-gray-200 transition duration-300"><AiOutlineInstagram /></a>
    </div>
